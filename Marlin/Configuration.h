...
#define STRING_CONFIG_H_AUTHOR "(droxey, SKR-Mini-E3-v2.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "droxeybot"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.73, 80.73, 403.63, 397.5 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 64.0, 0.0, -1.0 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 29       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
